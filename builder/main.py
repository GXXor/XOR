...
def main():
    stars = requests.get(
        f"https://api.github.com/repos/GXXor/XOR").json()["stargazers_count"]
    forks = requests.get(
        f"https://api.github.com/repos/XGXXor/XOR").json()["forks_count"]
    ...
    console.print(pyfiglet.figlet_format("GXDIVO", font="graffiti"),
                  justify="center", highlight=False, style="magenta", overflow="ignore")
    console.print(f"Xor Key Easy to use By: Ahmed Divo.\nStars: {stars} | Forks: {forks}",
